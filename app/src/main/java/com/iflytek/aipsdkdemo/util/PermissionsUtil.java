...
//                e.printStackTrace();
            Logs.e("AIPSDKDemo", "[" + Thread.currentThread().getName() + "][" + TAG + "][getAppName] " + " e:" + e.getMessage());
        }
        return appName;
    }
    ...
    static final class PLog {
        private static void d(String msg) {
            if (sDebug)
                Logs.d("AIPSDKDemo", "[" + Thread.currentThread().getName() + "][" + TAG + "][PLog] " + msg);
            //Log.d(TAG, msg);
        }

        private static void e(String msg) {
            if (sDebug)
                Logs.e("AIPSDKDemo", "[" + Thread.currentThread().getName() + "][" + TAG + "][PLog] " + msg);
            //  Log.e(TAG, msg);
        }
    }
}
