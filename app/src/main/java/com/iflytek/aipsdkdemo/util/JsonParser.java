...
//                e.printStackTrace();
            Logs.e("AIPSDKDemo", "[" + Thread.currentThread().getName() + "][" + TAG + "][parseIatResult] " + " e:" + e.getMessage());
		}
		return ret.toString();
	}
...
//                e.printStackTrace();
            Logs.e("AIPSDKDemo", "[" + Thread.currentThread().getName() + "][" + TAG + "][parseGrammarResult] " + " e:" + e.getMessage());
			ret.append("没有匹配结果.");
		}
		return ret.toString();
	}
